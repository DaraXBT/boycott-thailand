        ...
        <Card className={`group overflow-hidden transition-all duration-200 hover:shadow-lg ${
            ...
            'bg-amber-50/30'
                ...
                <div className="flex gap-3 w-full md:w-auto md:ml-auto">
                        {item.status === 'pending' && (
                        <>
                            {/* REJECT BUTTON: High contrast red text on white, turns solid red on hover */}
                            <Button 
                                onClick={() => onStatusChange(item.id, 'rejected')} 
                                variant="ghost"
                                className="flex-1 md:flex-none justify-center h-9 text-xs font-semibold bg-white border border-red-200 text-red-600 hover:bg-red-600 hover:text-white hover:border-red-600 shadow-sm transition-all"
                            >
                            ...
                            <Button 
                                ...
                                className="flex-1 md:flex-none justify-center h-9 text-xs font-semibold bg-green-600 text-white hover:bg-green-700 border border-green-700 shadow-sm transition-all"
                            >
