       ...
       <div className="max-w-md mx-auto py-16 px-4 animate-in fade-in zoom-in duration-300">
        <Card className="p-10 text-center space-y-6 rounded-3xl border-slate-100 shadow-xl">
          ...
          <div className="space-y-3">
              ...
              <Button onClick={onBack} variant="ghost" className="w-full text-slate-500 hover:text-slate-900">
                {t('cancel')}
              </Button>
          </div>
        </Card>
    ...
    return (
       <div className="max-w-md mx-auto py-16 px-4 animate-in fade-in zoom-in duration-300">
        <Card className="p-12 text-center space-y-8 rounded-3xl border-slate-100 shadow-xl shadow-slate-200/50">
          ...
          <Button onClick={onBack} variant="outline" className="w-full h-12 rounded-xl border-slate-200 hover:bg-slate-50 hover:text-slate-900 font-medium">
            {t('returnListings')}
          </Button>
        </Card>
      </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 md:p-10 space-y-8">
          ...
          <div className="pt-2 flex flex-col md:flex-row gap-4">
            ...
            >
             ...
             <Button type="button" variant="ghost" onClick={onBack} className="flex-none h-12 rounded-xl text-slate-500 hover:text-slate-900 hover:bg-slate-100">{t('cancel')}</Button>
          </div>
        </form>
      </Card>
    </div>
